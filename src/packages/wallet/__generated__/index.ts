...
import WalletTransactions, {WalletTransactions_InsertParameters} from './walletTransactions'
import Wallets, {Wallets_InsertParameters} from './wallets'

interface DatabaseSchema {
  wallets: {record: Wallets, insert: Wallets_InsertParameters};
  walletTransactions: {record: WalletTransactions, insert: WalletTransactions_InsertParameters};
}
